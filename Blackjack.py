...
class Blackjack(object):
    ...
    def dealer_turn(self):
        ...
        # Dealer did not bust or get a blackjack during their turn
        else:
    ...
    def game_result(self, playerHand, playerHandID):
        ...
        # If both the dealer's hand and the player's hand busted then the dealer still wins
            ...
            print(f"Even though player's {playerHandID} hand and the dealer's hand busted, the house always wins.\n")
            sleep(1)
